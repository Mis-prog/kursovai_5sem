...
/** \internal
  * print_result the matrix \a _m to the output stream \a s using the output format \a fmt */
template<typename Derived>
std::ostream & print_matrix(std::ostream & s, const Derived& _m, const IOFormat& fmt)
{
...
/** \relates DenseBase
  ...
  *
  * If you wish to print_result the matrix with a format different than the default, use DenseBase::format().
  *
